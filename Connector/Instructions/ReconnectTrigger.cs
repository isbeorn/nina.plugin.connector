...
namespace NINA.Plugins.Connector.Instructions {
    ...
    [ExportMetadata("Name", "Reconnect Equipment")]
    [ExportMetadata("Description", "A trigger that will fire when the selected equipment is disconnected and will try to reconnect")]
