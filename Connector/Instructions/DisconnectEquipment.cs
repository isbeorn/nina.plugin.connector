...
namespace NINA.Plugins.Connector.Instructions {
    [ExportMetadata("Name", "Disconnect Equipment")]
    [ExportMetadata("Description", "Disconnects the currently selected equipment")]
    [ExportMetadata("Icon", "Connector.DisconnectSVG")]
