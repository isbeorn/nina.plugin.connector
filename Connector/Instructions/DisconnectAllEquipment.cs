...
namespace NINA.Plugins.Connector.Instructions {
    [ExportMetadata("Name", "Disconnect All Equipment")]
    [ExportMetadata("Description", "Disconnects all equipment that is currently connected")]
    [ExportMetadata("Icon", "Connector.DisconnectAllSVG")]
